...
.news-content-wrapper {
  display: grid;
  grid-template-columns: 35% 65%; /* 右侧区域更大 */
...
.news-visual-expanded {
  ...
  .visual-container {
    height: 80%;
    background: linear-gradient(135deg, #f0f8ff 0%, #e6f7ff 100%); /* 柔和的蓝白渐变背景 */
    display: flex;
    align-items: center;
    ...
    .image-container {
      ...
      z-index: 2;
      border-radius: 8px;
      box-shadow: 0 6px 16px rgba(26, 109, 255, 0.15); /* 蓝色调阴影 */
      border: 1px solid rgba(26, 109, 255, 0.1); /* 轻微边框 */
    }
